...
func dataSourcePrivateDNSZones() *schema.Resource {
	return &schema.Resource{
		Read: dataSourcePrivateDNSZonesRead,
...
func dataSourcePrivateDNSZonesRead(d *schema.ResourceData, m interface{}) error {
